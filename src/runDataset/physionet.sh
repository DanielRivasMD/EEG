#!/bin/bash
# set -euo pipefail
# DOC: control model training on physionet. call MindReader ReadMind.jl

####################################################################################################

# iterate on patient directories
for patient in $(command find /Users/drivas/Factorem/EEG/data/physionet.org/files/chbmit/1.0.0/* -type d)
do
